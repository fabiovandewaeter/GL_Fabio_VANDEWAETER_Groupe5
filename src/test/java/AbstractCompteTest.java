...
public abstract class AbstractCompteTest<T extends AbstractCompte> {
	protected T c;
	
	@BeforeEach
	void init() {
		this.c = this.createCompte();
	}
	
	abstract public T createCompte();
	...
	public void creditAccountResetCreditsArrayWhenMaxCapacityReached() {
		...
		this.c.creditAccount(50);
		assertEquals(1, this.c.getCreditIndex());
		assertEquals(beforeReset+50, this.c.getCredit());
	}
